...
import {formatter} from './modules/utilities.js';
...
const averageSalaryByRole = formatter.format(getAverageSalaryByRole(role));

//averageSalaryByRole = formatter(averageSalaryByRole);
const averageSalaryByCompany = formatter.format(getAverageSalaryByCompany(company));
const salary = formatter.format(getSalaryAtCompany(role, company));
const industryAverageSalary = formatter.format(getIndustryAverageSalary());
